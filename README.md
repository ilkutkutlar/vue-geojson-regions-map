...
| custom-view           | `ol.View`                               | `undefined`    | If desired, a custom OpenLayers [View](https://openlayers.org/en/latest/apidoc/module-ol_View-View.html) object can be passed instead of the custom one. This can be useful for setting custom extents, min/max zoom, etc.                                                                                                |
